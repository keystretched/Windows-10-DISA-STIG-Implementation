<#
.SYNOPSIS
    This PowerShell script prevents users from immediately cycling through passwords to reuse an old one.
...
# WN10-AC-000030 - Minimum Password Age = 1

# Set minimum password age to 1 day for local accounts
